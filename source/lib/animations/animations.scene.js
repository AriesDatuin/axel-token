...
$$("a[href='#'].scroll-to").on("mouseover", function() {
	"use strict";
...
if ( $pauseAnimationOnScroll ) {

	$$(pageContent).on("scrollstart", { latency: $updateInterval }, animScenePauseAll);
	$$(pageContent).on("scrollstop", { latency: $updateInterval }, animSceneController);
