...
var pages = function() {
	...
	/* -------------------------------------------------- */
		...
		var subMenuOpen = function() {
			...
			subMenuContainer.find(".ui-open").addClass("hide").css({"pointer-events" : "none"});
			subMenuContainer.find(".ui-close").removeClass("hide");
		...
		var subMenuClose = function() {
			...
			subMenuContainer.find(".ui-open").removeClass("hide");
			subMenuContainer.find(".ui-close").addClass("hide");
			...
			TweenMax.delayedCall($delayInterval, function() { subMenuContainer.find(".ui-open").css({"pointer-events" : "auto"}); } );
		...
		subMenuContainer.find(".ui-open").on("click", function(e) {
			e.preventDefault();
		...
		subMenuContainer.find(".ui-close").on("click", function(e) {
			e.preventDefault();
