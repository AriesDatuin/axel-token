...
/* -------------------------------------------------- */
	...
	if ( $isSmallScreen ) {
		...
		console.log("Viewing on small screen: " + $$(pageContent).width() + "px" );
	...
	if ( $isMediumScreen ) {
		...
		console.log("Viewing on medium screen: " + $$(pageContent).width() + "px" );
	...
	if ( $isLargeScreen ) {
		...
		console.log("Viewing on large screen: " + $$(pageContent).width() + "px" );
