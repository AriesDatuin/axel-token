...
var comCounter = function() {
	...
	var tlCounter = new TimelineMax({paused: true});
		tlCounter.fromTo(counter01, 0.25, {autoAlpha: 0},
										  {autoAlpha: 1, delay: 0, ease: Power4.easeOut, onStart: function() { counter01.html(200); } })

				 .fromTo(counter02, 0.25, {autoAlpha: 0},
				 						  {autoAlpha: 1, delay: 0.15, ease: Power4.easeOut, onStart: function() { counter02.html(1300); } });
	...
	var counterController = function() {
		...
		if ( counter01.hasClass("anim-play") || counter02.hasClass("anim-play") ) {
