...
var pages=function(){"use strict";var e=$$(".page").data("page"),a=$$(".link-home"),s=$$(".link-privacy-policy"),r=$$(".link-eula");if("index"===e){a.addClass("active");var d=function(){$$("#hero");var e=$$("#hero header"),a=new SplitText(e.find("h1"),{type:"words, chars, lines"}).words,s=new SplitText(e.find("p"),{type:"words, chars, lines"}).words;TweenMax.set(e.find(".button-group").children(),{autoAlpha:0,scale:.95,transformOrigin:"center center",perspective:100,y:5});var r=new TimelineMax({paused:!0});r.staggerFrom(a,.5,{autoAlpha:0,y:5,ease:Power4.easeInOut},.1,"start-=0").staggerFrom(s,.25,{autoAlpha:0,y:5,ease:Power4.easeInOut},.05,"-=0.25").staggerTo(e.find(".button-group").children(),.25,{autoAlpha:1,scale:1,transformOrigin:"center center",perspective:100,y:5,ease:Power4.easeInOut},.2,"-=1"),hero.hasClass("sticky")?r.seek("end",!1):r.play().timeScale(1).delay($delayInterval)};d(),$hasTouch||$$(pageContent).on("resize",_.debounce(d,$delayInterval))}else"privacy-policy"===e?(s.addClass("active"),navbar.addClass("dark"),body.addClass("background-white"),body.addClass("background-image-none"),$("#ui-privacy-policy-message a").hide(),$("#ui-privacy-policy-message").addClass("text-center")):"eula"===e?(r.addClass("active"),navbar.addClass("dark"),body.addClass("background-white"),body.addClass("background-image-none")):navbar.addClass("dark")};
