...
var comCounter=function(){var e=$$("#counter-01.anim"),a=$$("#counter-02.anim");window.counterOptions={value:0,selector:".odometer",format:"(,ddd)",duration:5e3,theme:"minimal",animation:"count"};var o=new TimelineMax({paused:!0});o.from(e,.75,{autoAlpha:0,delay:0,ease:Power4.easeOut,onStart:function(){e.html(200)}}).from(a,.75,{autoAlpha:0,delay:.25,ease:Power4.easeOut,onStart:function(){a.html(1300)}});var t=function(){e.hasClass("anim-play")&&o.play()};$$(pageContent).on("scrollstop",t),TweenMax.delayedCall($delayInterval,t)},comModal=function(){$$("<div class='blocker'></div>").appendTo($$(body));var a=function(){$$(html).hasClass("blocker-active")?TweenMax.to($$(".blocker"),.25,{display:"none",opacity:0,delay:.25,ease:Power4.easeOut,onStart:function(){enableContent(),$$(html).removeClass("blocker-active"),$$(".blocker").addClass("no-pointer")}}):TweenMax.to($$(".blocker"),.25,{display:"block",opacity:.9,ease:Power4.easeIn,onStart:function(){disableContent(),$$(html).addClass("blocker-active"),$$(".blocker").addClass("no-pointer")},onComplete:function(){$$(".blocker").removeClass("no-pointer")}})};$$(".blocker").on("click",function(e){e.preventDefault(),a(),i()});var e=$$(".popup");$$("<div class='modal grid-x align-center align-top' tabindex='-1' aria-hidden='true' role='dialog'><div id='modal-preloader' class='mini-preloader light'><span class='fa fa-circle-o-notch fa-spin' aria-hidden='true' role='document'></span><p>Loading...</p></div><div class='cell modal-container position-relative z-01'></div><div class='modal-close close dark margin-sm round-full z-02'><span></span><span></span></div></div>").appendTo($$(body)),TweenMax.set($$(".modal"),{display:"none",opacity:0});var i=function(n,l){a(),$$(html).hasClass("blocker-active")?TweenMax.to($$(".modal"),.25,{display:"none",opacity:0,ease:Expo.easeOut,onStart:function(){},onComplete:function(){$$(".modal-container").html("")}}):TweenMax.to($$(".modal"),.25,{display:"block",opacity:1,ease:Expo.easeOut,onStart:function(){$$(html).addClass("no-pointer"),$$(".modal-close").not(".close").css({display:"none"}),$$(".modal-container").load(n+l,function(e,a,o){if(TweenMax.set($$("#modal-preloader"),{display:"block",opacity:1,scale:1}),"success"==a)TweenMax.to($$("#modal-preloader"),.25,{display:"none",opacity:0,scale:.75,delay:0,ease:Expo.easeInOut}),$$(".modal-close").not(".close").css({display:"block"});else{var t="Error: Unable to load "+n+l;$$(this).html('<div class="center-vh text-charcoal text-center"> <span class="fa fa-exclamation-circle p4" aria-hidden="true"></span> <p>'+t+"</p> </div>"),TweenMax.to($$("#modal-preloader"),.25,{display:"none",opacity:0,scale:.75,delay:.5,ease:Expo.easeInOut})}})},onComplete:function(){$$(html).removeClass("no-pointer")}})};$$(pageContent).on("resize",_.debounce(function(){$$(".modal").length&&$$(".modal").hasClass("modal-auto")&&TweenMax.set($$(".modal"),{width:window.innerWidth/1.2,height:window.innerHeight/1.2})},$updateInterval)),e.on("click",function(e){e.preventDefault();var a,o,t=$(this),n=null,l=t.data("content-selector");"auto"===t.data("content-width")?($$(".modal").addClass("modal-auto"),a=window.innerWidth/1.2):($$(".modal").removeClass("modal-auto"),a=t.data("content-width")),"auto"===t.data("content-height")?($$(".modal").addClass("modal-auto"),o=window.innerHeight/1.2):($$(".modal").removeClass("modal-auto"),o=t.data("content-height")),n=t.is("a")?t.attr("href"):t.data("content-url"),i(n," #"+l,a,o),TweenMax.set($$(".modal"),{width:a,height:o})}),$$(".modal-close").on("click",function(e){e.preventDefault(),i()})},comParallax=function(){dzsprx_init(".dzsparallaxer",{direction:"reverse",settings_mode:"scroll",mode_scroll:"normal",animation_duration:"5",easing:"easeInOutSine"})},comSlider=function(){"use strict";var e=$$(".slider-default"),a=$$(".slider-default.adapt").flickity({});TweenMax.set(e,{autoAlpha:0}),TweenMax.to(e,.5,{autoAlpha:1,delay:1});TweenMax.delayedCall($delayInterval,function(){e.flickity("resize")}),e.has(".adapt").each(function(){var e=$(this);e.find("ol.flickity-page-dots").prependTo($(this).find(".flickity-viewport")),e.find(".flickity-viewport").css("height",$(this).find(".flickity-viewport .slider-item.is-selected .cell").height()+"px")}),$(".slider-item a").on("click touchdown",function(e){}),a.on("select.flickity",function(){var e=$(this);e.each(function(){e.find(".flickity-viewport").css("height",$(this).find(".flickity-viewport .slider-item.is-selected .cell").height()+"px")})}),8<$$("ol.flickity-page-dots > li.dot").length&&$isSmallScreen&&$$("ol.flickity-page-dots > li.dot").remove();$$(pageContent).on("scrollstop",function(){e.each(function(){var e=$(this);e.hasClass("anim-play")?($$(pageContent).on("scrollstart",function(){e.flickity("pausePlayer")}),$$(pageContent).on("scrollstop",function(){e.flickity("unpausePlayer")}),e.flickity("playPlayer")):e.flickity("stopPlayer")})})},comStories=function(){var e=$$("#stories .profiles .cell");$$("#stories .profiles"),$$("#josh"),$$("#shera"),$$("#tina");TweenMax.set(e.find("[data-src]"),{autoAlpha:0,scale:1.12}),e.on("mouseover touchstart",function(){var e=$(this);e.addClass("overflow-hidden"),TweenMax.to(e.find(".story-icon"),.75,{autoAlpha:0,scale:.75,ease:Back.easeOut}),TweenMax.to(e.find(".text-container"),1,{autoAlpha:0,ease:Power4.easeOut}),TweenMax.to(e.find("a.button"),1,{autoAlpha:0,ease:Power4.easeOut}),TweenMax.to(e.find("[data-src]"),.5,{autoAlpha:1,scale:1,ease:Power4.easeOut})}).on("mouseout touchend touchleave",function(){var e=$(this);TweenMax.to(e.find(".text-container"),.75,{autoAlpha:1,ease:Power4.easeOut}),TweenMax.to(e.find("a.button"),.75,{autoAlpha:1,ease:Power4.easeOut}),TweenMax.to(e.find("[data-src]"),.25,{autoAlpha:0,scale:1.12,ease:Power4.easeOut,onComplete:function(){e.removeClass("overflow-hidden"),TweenMax.to(e.find(".story-icon"),.5,{autoAlpha:1,scale:1,ease:Back.easeOut})}})})};
