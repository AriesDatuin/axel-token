...
var pages=function(){"use strict";var e=$$(".page").data("page"),a=$$(".link-home"),s=$$(".link-about"),t=$$(".link-team"),r=$$(".link-privacy-policy"),d=$$(".link-eula");if("index"===e){a.addClass("active");var n=function(){$$("#welcome");var e=$$("#welcome header"),a=new SplitText(e.find("h1"),{type:"words, chars, lines"}).words,s=new SplitText(e.find("p"),{type:"words, chars, lines"}).words;TweenMax.set(e.find(".button-group").children(),{autoAlpha:0,scale:.95,rotationX:0,transformOrigin:"center center",perspective:100,y:5}),e.find("h1").removeClass("header-accent header-accent-left header-accent-primary");var t=new TimelineMax({paused:!0});t.staggerFrom(a,.5,{autoAlpha:0,y:5,ease:Power4.easeInOut},.1,"start-=0").staggerFrom(s,.25,{autoAlpha:0,y:5,ease:Power4.easeInOut},.05,"-=0.25").staggerTo(e.find(".button-group").children(),.25,{autoAlpha:1,scale:1,rotationX:0,transformOrigin:"center center",perspective:100,y:5,ease:Power4.easeInOut},.2,"-=1").add(function(){e.find("h1").addClass("header-accent header-accent-left header-accent-primary")}),hero.hasClass("sticky")?t.seek("end",!1):t.play().timeScale(1).delay($delayInterval)};n(),$hasTouch||$$(pageContent).on("resize",_.debounce(n,$delayInterval))}else if("about"===e){s.addClass("active");$$(pageContent).on("scrollstop",function(){$("#team").hasClass("emergence-visible")?(s.removeClass("active"),t.addClass("active")):(s.addClass("active"),t.removeClass("active"))})}else"team"===e?t.addClass("active"):"privacy-policy"===e?(r.addClass("active"),navbar.addClass("dark"),body.addClass("background-white"),body.addClass("background-image-none"),$("#ui-privacy-policy-message a").hide(),$("#ui-privacy-policy-message").addClass("text-center")):"eula"===e?(d.addClass("active"),navbar.addClass("dark"),body.addClass("background-white"),body.addClass("background-image-none")):navbar.addClass("dark")};
var components=function(){utilPageVisibility(),animController(),detectHover()},core=function(){uiInit(),uiCommon(),uiLinkDelegation(),uiScrollEvents(),uiSmoothScroll(),uiNav(),uiButtons(),uiRelayout(),comCaseStudies(),comModal(),comSlider(),utilAssetObserver(),utilDataAttributes(),utilEmergence(),utilPrint(),pages()},disableContent=function(){"use strict";html.css({"overflow-x":"hidden","overflow-y":"hidden"})},enableContent=function(){"use strict";html.css({"overflow-x":"hidden","overflow-y":"scroll"})};if($usePreloader){TweenMax.set(body,{autoAlpha:1});var tlPreloaderStart=new TimelineMax({paused:!0});tlPreloaderStart.call(disableContent).to(preloader,.25,{display:"block",opacity:1,ease:Power2.easeOut}).to([container,navPanel,navbar,toolbar],.5,{display:"block",autoAlpha:1,ease:Power2.easeOut});var tlPreloaderEnd=new TimelineMax({paused:!0});tlPreloaderEnd.to([container,navPanel,navbar,toolbar],.25,{opacity:1,ease:Power2.easeOut}).to(preloader,.25,{autoAlpha:0,ease:Power2.easeOut}).call(enableContent)}else enableContent(),TweenMax.set([container,navPanel,navbar,toolbar],{display:"block",opacity:1,delay:.75});function onLoad(e,t){"use strict";if("complete"===document.readyState)return t();e(),window.addEventListener?window.addEventListener("load",t,!1):window.attachEvent&&window.attachEvent("onload",t)}onLoad(function(){"use strict";$usePreloader&&tlPreloaderStart.play(0).timeScale(1).delay(0)},function(){"use strict";$usePreloader?(tlPreloaderEnd.play(0).timeScale(1).delay(1),TweenMax.delayedCall(tlPreloaderEnd.duration()+$delayInterval,components)):TweenMax.delayedCall($delayInterval,components),core()});