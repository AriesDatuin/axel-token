...
var watchEvents=function(){$("[data-anim]").on("mouseover touchstart",function(t){var n=$(this),a=t.target,i="anim-",e=a.dataset.anim,s=a.dataset.animDuration,o=a.dataset.animRepeat,u=a.dataset.animTiming,r=a.dataset.animBind,l=a.dataset.animId;if(void 0===e)return!1;if("true"===r){if(void 0===l)return!1;if(null==(m=document.getElementById(l)))return!1;var d=m;m.parentNode.replaceChild(d,m),d.classList.add(i+e)}else{var m;d=m=a;m.parentNode.replaceChild(d,m),d.classList.add(i+e)}void 0!==s?isNaN(s)?d.style.animationDuration="0.45s":d.style.animationDuration=s+"s":d.style.animationDuration="0.45s",void 0!==u&&("linear"===u||"ease-in"===u||"ease-out"===u||"ease-in-out"===u)?d.classList.add(i+u):d.classList.add(i+"ease-in-out"),d.style.animationIterationCount=void 0!==o?"infinite"===u?"infinite":o:"1",n.removeClass("anim-pause")}).on("mouseout touchend",function(t){var n=$(this);n.addClass("anim-pause")}),$(".anim").on("mouseout touchend",function(t){$(this).css({"animation-name":"none"})})};"loading"!=document.readyState?watchEvents():document.addEventListener("DOMContentLoaded",function(){watchEvents()});var anim=(anim=function(){var n,a;return{getEle:function(t){return null!=(n=document.querySelector(t))&&null!=n&&(a=n).parentNode.replaceChild(a,n),this},interaction:function(t){if(null!=a){if(null!=t&&null!=t&&-1==t.indexOf(" ")){var n="anim-"+t;return a.classList.add(n),this}return this}return this},duration:function(t){return null!=a&&null!=a&&0==isNaN(t)&&(a.style.animationDuration=t+"s"),this},timing:function(t){if(null!=a&&null!=a){if("linear"==t||"ease-in"==t||"ease-out"==t||"ease-in-out"==t){var n="anim-"+t;return a.classList.add(n),this}return this}return this},repeat:function(t){return null!=a&&null!=a&&0==isNaN(t)&&(a.style.animationIterationCount=t),this}}})();"object"==typeof module&&module.exports&&(module.exports=anim);
