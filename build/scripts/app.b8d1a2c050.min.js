...
var page=$$(".page").data("page"),linkHome=$$(".link-home"),pages=function(){"use strict";if("index"===page){linkHome.addClass("active");var e=function(){$$("#hero");var e=$$("#hero header"),a=new SplitText(e.find("h1"),{type:"words, chars, lines"}).words,r=new SplitText(e.find("p"),{type:"words, chars, lines"}).words;TweenMax.set(e.find(".button-group").children(),{autoAlpha:0,scale:.95,transformOrigin:"center center",perspective:100,y:5});var t=new TimelineMax({paused:!0});t.staggerFrom(a,.5,{autoAlpha:0,y:5,ease:Power4.easeInOut},.1,"start-=0").staggerFrom(r,.25,{autoAlpha:0,y:5,ease:Power4.easeInOut},.05,"-=0.25").staggerTo(e.find(".button-group").children(),.25,{autoAlpha:1,scale:1,transformOrigin:"center center",perspective:100,y:5,ease:Power4.easeInOut},.2,"-=1"),hero.hasClass("sticky")?t.seek("end",!1):t.play().timeScale(1).delay($delayInterval)};e(),$hasTouch||$$(pageContent).on("resize",_.debounce(e,$delayInterval))}};
