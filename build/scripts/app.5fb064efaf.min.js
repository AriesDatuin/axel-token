...
var watchEvents=function(){$(window).on("click mouseover touchstart",function(t){var n=t.target,e="mjs-",i=n.dataset.micron,a=n.dataset.micronDuration,r=n.dataset.micronTiming,o=n.dataset.micronBind,s=n.dataset.micronId;if(void 0===i)return!1;if("true"===o){if(void 0===s)return!1;if(null==(l=document.getElementById(s)))return!1;var u=l;l.parentNode.replaceChild(u,l),u.classList.add(e+i)}else{var l;u=l=n;l.parentNode.replaceChild(u,l),u.classList.add(e+i)}void 0!==a?isNaN(a)?u.style.animationDuration=".45s":u.style.animationDuration=a+"s":u.style.animationDuration=".45s",void 0!==r&&("linear"===r||"ease-in"===r||"ease-out"===r||"ease-in-out"===r)?u.classList.add(e+r):u.classList.add(e+"ease-in-out")})};"loading"!=document.readyState?watchEvents():document.addEventListener("DOMContentLoaded",function(){watchEvents()});var Micron=function(){var n,e;return{getEle:function(t){return null!=(n=document.querySelector(t))&&null!=n&&(e=n).parentNode.replaceChild(e,n),this},interaction:function(t){if(null!=e){if(null!=t&&null!=t&&-1==t.indexOf(" ")){var n="mjs-"+t;return e.classList.add(n),this}return this}return this},duration:function(t){return null!=e&&null!=e&&0==isNaN(t)&&(e.style.animationDuration=t+"s"),this},timing:function(t){if(null!=e&&null!=e){if("linear"==t||"ease-in"==t||"ease-out"==t||"ease-in-out"==t){var n="mjs-"+t;return e.classList.add(n),this}return this}return this}}},micron=Micron();"object"==typeof module&&module.exports&&(module.exports=micron);
