...
var components=function(){comParallax(),utilEmergence(),utilPageVisibility(),animController(),hasTouch()},core=function(){comCounter(),comModal(),comSlider(),comStories(),utilAssetObserver(),utilDataAttributes(),utilPrint(),uiInit(),uiCommon(),uiLinkDelegation(),uiScrollEvents(),uiSmoothScroll(),uiButtons(),pages()},disableContent=function(){"use strict";html.css({"overflow-x":"hidden","overflow-y":"hidden"}),bodyScrollLock.disableBodyScroll(document.querySelector(".modal"))},enableContent=function(){"use strict";html.css({"overflow-x":"hidden","overflow-y":"scroll"}),bodyScrollLock.clearAllBodyScrollLocks()};if($usePreloader){TweenMax.set(body,{autoAlpha:1});var tlPreloaderStart=new TimelineMax({paused:!0});tlPreloaderStart.call(disableContent).to(preloader,.25,{display:"block",opacity:1,ease:Power2.easeOut}).to([container,navPanel,navbar,toolbar],.5,{display:"block",autoAlpha:1,ease:Power2.easeOut});var tlPreloaderEnd=new TimelineMax({paused:!0});tlPreloaderEnd.to([container,navPanel,navbar,toolbar],.25,{opacity:1,ease:Power2.easeOut}).to(preloader,.25,{autoAlpha:0,ease:Power2.easeOut}).call(enableContent)}else enableContent(),TweenMax.set([container,navPanel,navbar,toolbar],{display:"block",opacity:1,delay:.75});function onLoad(e,o){"use strict";if("complete"===document.readyState)return o();e(),window.addEventListener?window.addEventListener("load",o,!1):window.attachEvent&&window.attachEvent("onload",o)}onLoad(function(){"use strict";$usePreloader&&tlPreloaderStart.play(0).timeScale(1).delay(0)},function(){"use strict";$usePreloader?(tlPreloaderEnd.play(0).timeScale(1).delay(1),TweenMax.delayedCall(tlPreloaderEnd.duration()+$delayInterval,components)):TweenMax.delayedCall($delayInterval,components),core()});