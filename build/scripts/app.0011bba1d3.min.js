...
var pages=function(){"use strict";var a=$$(".page").data("page"),e=$$(".link-home"),s=$$(".link-about"),d=$$(".link-team"),l=$$(".link-privacy-policy"),t=$$(".link-eula");if("index"===a){e.addClass("active");$$("#welcome");var i=$$("#welcome header"),o=new SplitText(i.find("h1"),{type:"words, chars, lines"}).words,r=new SplitText(i.find("p"),{type:"words, chars, lines"}).words,n=new TimelineMax({paused:!0});n.staggerFrom(o,.5,{autoAlpha:0,y:5,ease:Power4.easeInOut},.1,"start-=0").staggerFrom(r,.25,{autoAlpha:0,y:5,ease:Power4.easeInOut},.05,"-=0.25").from(i.find(".button"),.5,{autoAlpha:0,ease:Power4.easeOut},"-=1").fromTo(i.find("form"),.5,{autoAlpha:0,ease:Power4.easeOut},{autoAlpha:1,ease:Power4.easeOut},"-=0.75"),hero.hasClass("sticky")?n.seek("end",!1):n.play().timeScale(1).delay($delayInterval)}else if("about"===a){s.addClass("active");$$(pageContent).on("scrollstop",function(){$("#team").hasClass("emergence-visible")?(s.removeClass("active"),d.addClass("active")):(s.addClass("active"),d.removeClass("active"))})}else"team"===a?d.addClass("active"):"privacy-policy"===a?(l.addClass("active"),navbar.addClass("dark"),body.addClass("background-white"),body.addClass("background-image-none"),$("#ui-privacy-policy-message a").hide(),$("#ui-privacy-policy-message").addClass("text-center")):"eula"===a?(t.addClass("active"),navbar.addClass("dark"),body.addClass("background-white"),body.addClass("background-image-none")):navbar.addClass("dark")};
