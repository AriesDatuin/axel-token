...
var pages=function(){"use strict";var a=$$(".page").data("page"),e=$$(".link-home"),s=$$(".link-about"),t=$$(".link-team"),r=$$(".link-privacy-policy"),d=$$(".link-eula");if("index"===a){e.addClass("active");var n=function(){$$("#hero");var a=$$("#hero header"),e=new SplitText(a.find("h1"),{type:"words, chars, lines"}).words,s=new SplitText(a.find("p"),{type:"words, chars, lines"}).words;TweenMax.set(a.find(".button-group").children(),{autoAlpha:0,scale:.95,transformOrigin:"center center",perspective:100,y:5});var t=new TimelineMax({paused:!0});t.staggerFrom(e,.5,{autoAlpha:0,y:5,ease:Power4.easeInOut},.1,"start-=0").staggerFrom(s,.25,{autoAlpha:0,y:5,ease:Power4.easeInOut},.05,"-=0.25").staggerTo(a.find(".button-group").children(),.25,{autoAlpha:1,scale:1,transformOrigin:"center center",perspective:100,y:5,ease:Power4.easeInOut},.2,"-=1"),hero.hasClass("sticky")?t.seek("end",!1):t.play().timeScale(1).delay($delayInterval)};n(),$hasTouch||$$(pageContent).on("resize",_.debounce(n,$delayInterval))}else if("about"===a){s.addClass("active");$$(pageContent).on("scrollstop",function(){$("#team").hasClass("emergence-visible")?(s.removeClass("active"),t.addClass("active")):(s.addClass("active"),t.removeClass("active"))})}else"team"===a?t.addClass("active"):"privacy-policy"===a?(r.addClass("active"),navbar.addClass("dark"),body.addClass("background-white"),body.addClass("background-image-none"),$("#ui-privacy-policy-message a").hide(),$("#ui-privacy-policy-message").addClass("text-center")):"eula"===a?(d.addClass("active"),navbar.addClass("dark"),body.addClass("background-white"),body.addClass("background-image-none")):navbar.addClass("dark")};
