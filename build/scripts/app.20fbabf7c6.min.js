...
var animIcon=$$("svg.anim"),animIconMagnifyingGlass=$$("#icon-magnifying-glass"),animIconHacker=$$("#icon-hacker"),animIconEye=$$("#icon-eye"),animIconAnonymity=$$("#icon-anonymity"),animIconReputation=$$("#icon-reputation"),animIconDecentralization=$$("#icon-decentralization"),animIconDataCenters=$$("#icon-data-centers"),animIconGettingTokens=$$("#icon-getting-tokens"),animIconFullyProtected=$$("#icon-fully-protected"),animIconDualChainArchitecture=$$("#icon-dual-chain-architecture"),animIconWitnessPool=$$("#icon-witness-pool"),animIconWeightedReputationSystem=$$("#icon-weighted-reputation-system"),animIconUnification=$$("#icon-unification"),animIconComplete=function(){};TweenMax.set(animIcon,{transformOrigin:"center center"});var tlIconMagnifyingGlass=new TimelineMax({paused:!0,delay:0,repeatDelay:0,yoyo:!1,repeat:0,onComplete:animIconComplete});tlIconMagnifyingGlass.from(animIconMagnifyingGlass.find("#magnifying-glass"),.5,{autoAlpha:0,scale:.5,rotation:60,transformOrigin:"center center",delay:1,ease:Back.easeOut}).staggerFrom(animIconMagnifyingGlass.find("#people").children(),1,{autoAlpha:0,ease:Expo.easeOut},.12);var tlIconHacker=new TimelineMax({paused:!0,delay:0,repeatDelay:0,yoyo:!0,repeat:5,onComplete:animIconComplete});tlIconHacker.to(animIconHacker.find("#hacker-head"),1,{y:8,delay:0,ease:Bounce.easeOut}).to(animIconHacker.find("#hacker-head"),1,{y:4,ease:Back.easeOut});var tlIconEye=new TimelineMax({paused:!0,delay:0,repeatDelay:0,yoyo:!0,repeat:1,onComplete:animIconComplete});tlIconEye.to(animIconEye.find("#pupil"),.5,{rotation:-90,transformOrigin:"center center",delay:1,ease:Expo.easeOut}).to(animIconEye.find("#pupil"),.25,{rotation:0,ease:Expo.easeOut}).to(animIconEye,.15,{scaleY:.25,ease:Expo.easeIn}).to(animIconEye,.15,{scaleY:1,ease:Expo.easeIn});var tlIconAnonymity=new TimelineMax({paused:!0,delay:0,repeatDelay:0,yoyo:!1,repeat:0,onComplete:animIconComplete});tlIconAnonymity.staggerFrom(animIconAnonymity.find("#doc").children(),.5,{autoAlpha:0,ease:Back.easeOut},.12).staggerFrom(animIconAnonymity.find("#profile").children(),.25,{autoAlpha:0,scale:.5,transformOrigin:"top left",ease:Back.easeOut},.12).staggerFrom(animIconAnonymity.find("#lines").children(),.25,{autoAlpha:0,scaleX:0,transformOrigin:"left center",ease:Expo.easeOut},-.12,"-=0.75").set(animIconAnonymity.find("#padlock").find("#padlock-bar"),{y:-8}).from(animIconAnonymity.find("#padlock"),.25,{autoAlpha:0,scale:.75,transformOrigin:"center center",ease:Back.easeOut}).to(animIconAnonymity.find("#padlock").find("#padlock-bar"),.25,{y:0,ease:Back.easeOut});var tlIconReputation=new TimelineMax({paused:!0,delay:0,repeatDelay:0,yoyo:!1,repeat:0,onComplete:animIconComplete});tlIconReputation.from(animIconReputation.find("#doc"),.25,{autoAlpha:0,scale:.75,transformOrigin:"center center",ease:Back.easeOut}).staggerFrom(animIconReputation.find("#lines").children(),.25,{autoAlpha:0,scaleX:0,transformOrigin:"left center",ease:Expo.easeOut},-.12,"-=0.25").from(animIconReputation.find("#ribbon"),1,{autoAlpha:0,scale:.5,transformOrigin:"center center",ease:Elastic.easeOut});var tlIconDecentralization=new TimelineMax({paused:!0,delay:0,repeatDelay:0,yoyo:!1,repeat:0,onComplete:animIconComplete});tlIconDecentralization.staggerFrom(animIconDecentralization.find("#segments").children(),.25,{autoAlpha:0,scale:0,transformOrigin:"center center",ease:Back.easeOut},.12).staggerFrom(animIconDecentralization.find("#nodes").children(),1,{autoAlpha:0,ease:Expo.easeOut},.12,"-=0.75");var tlIconDataCenters=new TimelineMax({paused:!0,delay:0,repeatDelay:0,yoyo:!1,repeat:0,onComplete:animIconComplete});tlIconDataCenters.staggerFrom(animIconDataCenters.find("#nodes").children(),1,{autoAlpha:0,scale:0,transformOrigin:"center center",ease:Back.easeOut},.12).from(animIconDataCenters.find("#globe"),2,{autoAlpha:0,ease:Expo.easeOut},"-=0.5"),TweenMax.set(animIconGettingTokens.find("#token"),{autoAlpha:0,y:-20,scaleX:.5,scaleY:1.25,transformOrigin:"bottom center"});var tlIconGettingTokens=new TimelineMax({paused:!0,delay:0,repeatDelay:0,yoyo:!1,repeat:0,onComplete:animIconComplete});tlIconGettingTokens.to(animIconGettingTokens.find("#token"),.25,{autoAlpha:1,y:10,scaleX:1,scaleY:.75,ease:Back.easeOut}).to(animIconGettingTokens.find("#hand"),.5,{rotation:12,ease:Back.easeOut},"-=0.25").to(animIconGettingTokens.find("#token"),.25,{y:-8,scaleY:1,ease:Back.easeInOut}).to(animIconGettingTokens.find("#token"),.25,{y:0,scaleY:1,ease:Back.easeInOut}).to(animIconGettingTokens.find("#hand"),.25,{rotation:0,ease:Back.easeInOut},"-=0.5");var tlIconFullyProtected=new TimelineMax({paused:!0,delay:0,repeatDelay:0,yoyo:!1,repeat:0,onComplete:animIconComplete});tlIconFullyProtected.from(animIconFullyProtected.find("#shield"),.5,{autoAlpha:0,scale:.75,transformOrigin:"center center",delay:1,ease:Back.easeOut}).from(animIconFullyProtected.find("#shield-left-face"),.25,{autoAlpha:0,ease:Expo.easeOut},"-=0.5").from(animIconFullyProtected.find("#radio"),.5,{autoAlpha:0,rotation:360,scale:0,transformOrigin:"center center",ease:Back.easeOut}).from(animIconFullyProtected.find("#check"),.5,{autoAlpha:0,scale:0,rotation:90,transformOrigin:"center center",ease:Back.easeOut},"-=0.25");var tlIconDualChainArchitecture=new TimelineMax({paused:!0,delay:0,repeatDelay:0,yoyo:!1,repeat:0,onComplete:animIconComplete});tlIconDualChainArchitecture.from(animIconDualChainArchitecture.find("#chain-01"),.25,{autoAlpha:0,x:10,y:10,scale:0,transformOrigin:"center center",ease:Back.easeOut}).from(animIconDualChainArchitecture.find("#chain-02"),.25,{autoAlpha:0,x:-10,y:-10,scale:0,transformOrigin:"center center",ease:Back.easeOut},"-=0.25");var tlIconWitnessPool=new TimelineMax({paused:!0,delay:0,repeatDelay:0,yoyo:!1,repeat:0,onComplete:animIconComplete});tlIconWitnessPool.staggerFrom(animIconWitnessPool.children(),1,{autoAlpha:0,ease:Expo.easeOut},.25).staggerTo(animIconWitnessPool.children().children(),1,{autoAlpha:0,ease:Expo.easeOut},.12).staggerTo(animIconWitnessPool.children().children(),1,{autoAlpha:1,ease:Expo.easeOut},-.12);var tlIconWeightedReputationSystem=new TimelineMax({paused:!0,delay:0,repeatDelay:0,yoyo:!1,repeat:0,onComplete:animIconComplete});tlIconWeightedReputationSystem.staggerFrom(animIconWeightedReputationSystem.children(),1.25,{autoAlpha:0,scale:0,rotation:36,transformOrigin:"center center",ease:Elastic.easeOut},.12);var tlIconUnification=new TimelineMax({paused:!0,delay:0,repeatDelay:0,yoyo:!1,repeat:0,onComplete:animIconComplete});tlIconUnification.from(animIconUnification.find("#chain-01"),.5,{autoAlpha:0,x:10,scale:.75,rotation:60,transformOrigin:"center center",ease:Back.easeOut}).from(animIconUnification.find("#chain-02"),.5,{autoAlpha:0,x:-10,scale:.75,rotation:-60,transformOrigin:"center center",ease:Back.easeOut},"-=0.5");var animIconPlayAll=function(){},animIconController=function(){"use strict";animIconEye.hasClass("anim-play")?tlIconEye.play():tlIconEye.pause(0),animIconHacker.hasClass("anim-play")?tlIconHacker.play():tlIconHacker.pause(0),animIconMagnifyingGlass.hasClass("anim-play")?tlIconMagnifyingGlass.play():tlIconMagnifyingGlass.pause(0),animIconAnonymity.hasClass("anim-play")?tlIconAnonymity.play():tlIconAnonymity.pause(0),animIconReputation.hasClass("anim-play")?tlIconReputation.play():tlIconReputation.pause(0),animIconDecentralization.hasClass("anim-play")?tlIconDecentralization.play():tlIconDecentralization.pause(0),animIconDataCenters.hasClass("anim-play")?tlIconDataCenters.play():tlIconDataCenters.pause(0),animIconGettingTokens.hasClass("anim-play")?tlIconGettingTokens.play():tlIconGettingTokens.pause(0),animIconFullyProtected.hasClass("anim-play")?tlIconFullyProtected.play():tlIconFullyProtected.pause(0),animIconDualChainArchitecture.hasClass("anim-play")?tlIconDualChainArchitecture.play():tlIconDualChainArchitecture.pause(0),animIconWitnessPool.hasClass("anim-play")?tlIconWitnessPool.play():tlIconWitnessPool.pause(0),animIconWeightedReputationSystem.hasClass("anim-play")?tlIconWeightedReputationSystem.play():tlIconWeightedReputationSystem.pause(0),animIconUnification.hasClass("anim-play")?tlIconUnification.play():tlIconUnification.pause(0)};animIcon.on("mouseover touchdown",function(){"use strict";$(this).addClass("no-pointer"),animIconController()}),$$(pageContent).on("scrollstop",animIconController),TweenMax.delayedCall($delayInterval+2,animIconController);
