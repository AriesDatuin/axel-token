...
var pages=function(){"use strict";var a=$$(".page").data("page"),e=$$(".link-home"),s=$$(".link-about"),d=$$(".link-team"),t=$$(".link-privacy-policy"),l=$$(".link-eula");if("index"===a){e.addClass("active");var o=function(){$$("#welcome");var a=$$("#welcome header"),e=new SplitText(a.find("h1"),{type:"words, chars, lines"}).words,s=new SplitText(a.find("p"),{type:"words, chars, lines"}).words,d=new TimelineMax({paused:!0});d.staggerFrom(e,.5,{autoAlpha:0,y:5,ease:Power4.easeInOut},.1,"start-=0").staggerFrom(s,.25,{autoAlpha:0,y:5,ease:Power4.easeInOut},.05,"-=0.25").from(a.find(".button"),.5,{autoAlpha:0,ease:Power4.easeOut},"-=1").fromTo(a.find("form"),.5,{autoAlpha:0,ease:Power4.easeOut},{autoAlpha:1,ease:Power4.easeOut},"-=0.75").add(function(){a.find("h1").addClass("header-accent header-accent-left header-accent-primary")}),hero.hasClass("sticky")?d.seek("end",!1):d.play().timeScale(1).delay($delayInterval)};o(),$hasTouch||$$(pageContent).on("resize",_.debounce(o,$delayInterval))}else if("about"===a){s.addClass("active");$$(pageContent).on("scrollstop",function(){$("#team").hasClass("emergence-visible")?(s.removeClass("active"),d.addClass("active")):(s.addClass("active"),d.removeClass("active"))})}else"team"===a?d.addClass("active"):"privacy-policy"===a?(t.addClass("active"),navbar.addClass("dark"),body.addClass("background-white"),body.addClass("background-image-none"),$("#ui-privacy-policy-message a").hide(),$("#ui-privacy-policy-message").addClass("text-center")):"eula"===a?(l.addClass("active"),navbar.addClass("dark"),body.addClass("background-white"),body.addClass("background-image-none")):navbar.addClass("dark")};
